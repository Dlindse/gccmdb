...
class CountriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create country" do
    assert_difference('Country.count') do
      post countries_url, params: { country: { country: @country.country, truth_uuid: @country.truth_uuid } }
    end
  ...
  test "should update country" do
    patch country_url(@country), params: { country: { country: @country.country, truth_uuid: @country.truth_uuid } }
